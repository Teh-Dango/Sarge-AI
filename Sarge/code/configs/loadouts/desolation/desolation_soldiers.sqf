...
SAR_sold_leader_model 		= ["C_man_p_beggar_F"];  // DO NOT CHANGE THIS ARRAY!
...
SAR_sold_rifleman_model 	= ["C_man_p_beggar_F"];  // DO NOT CHANGE THIS ARRAY!
...
SAR_sold_sniper_model 		= ["C_man_p_beggar_F"];  // DO NOT CHANGE THIS ARRAY!
