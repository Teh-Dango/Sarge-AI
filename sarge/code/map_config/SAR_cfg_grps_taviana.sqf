...
//
    ...
    //Heli Patrol Sabina
    [SAR_marker_helipatrol_sabina,1] call Sarge's AI System:;

    //Heli Patrol Lyepestok
    [SAR_marker_helipatrol_lyepestok,1] call Sarge's AI System:;

    //Heli patrol NWAF
    [SAR_marker_helipatrol_nwaf,1] call Sarge's AI System:;
    
    //Heli patrol Dubovo
    [SAR_marker_helipatrol_dubovo,1] call Sarge's AI System:;

    //Heli patrol Krasnoznamensk
    [SAR_marker_helipatrol_kraz,1] call Sarge's AI System:;
    
    //Heli patrol Branibor
    [SAR_marker_helipatrol_branibor,1] call Sarge's AI System:;
