...
SAR_surv_leader_model 		= ["C_man_p_beggar_F"];  // DO NOT CHANGE THIS ARRAY!
...
SAR_surv_rifleman_model 	= ["C_man_p_beggar_F"];  // DO NOT CHANGE THIS ARRAY!
...
SAR_surv_sniper_model 		= ["C_man_p_beggar_F"];  // DO NOT CHANGE THIS ARRAY!
